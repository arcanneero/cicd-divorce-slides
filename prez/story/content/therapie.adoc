...
[NOTE.speaker]
====
Dans les templates suivants, on voit que le développeur cherche à factoriser l'analyse de code, mais ici, l'"interface" permet de couvrir tous les outils et les technos. L'exemple est un peu grossier, mais on le retrouve de temps.

Il vaut mieux avoir des jobs/templates spécialisés
====
