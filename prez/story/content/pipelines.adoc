...
image::nuage-de-mots.png[step 1]
...
image::Extreme_Programming.svg[step 1]

[NOTE.speaker]
====
Nicolas :
Sans être sur le même plan, on peut s'approcher de XP.
====
...
image::periodic.png[width=80%]
footnote:periodic[https://digital.ai/periodic-table-of-devops-tools]
...
* Voir pas utilisé
* Git ou SVN
* XLDeploy ou un système de déploiment obscur écrit en Pascal
