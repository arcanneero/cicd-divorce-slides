...
== Le cas "Industrialisez car c'est bien" (OAB)

* Objectif : Tout le monde le fait, donc faites-le (en gros, trouver un truc pour qu'on gagne plus d'argent)

* Problème : Mis en place par les devs, pour des devs
...
* Métriques qualités précises et top
...
* Ce pipeline vit très bien seul, mais ne peut pas vivre dans une société plus complexe

== Le cas "Les pipelines préformatés/théorisés"
...
* On force/impose une façon de travailler
...
== Notre approche : une méthode plus que des outils
